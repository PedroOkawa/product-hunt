...
public class Comment {
    ...
    public Comment(Long id, Long userId, Long parentCommentId, String body, java.util.Date createdAt, java.util.Date updateDate, Long childCommentsCount, Long postId) {
        this.id = id;
        this.userId = userId;
